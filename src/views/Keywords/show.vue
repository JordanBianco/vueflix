<template>
    <div>
        ...
        <section class="p-6 lg:px-12">
            ...
            <section v-if="shows.results.length > 0" class="grid lg:grid-cols-2 gap-8">
                <div v-for="show in shows.results" :key="show.id">
                    <div class="relative md:h-96">
                        <router-link
                            ...
                            class="md:flex shadow-md hover:shadow-xl rounded-lg md:h-96">
                                ...
                                <div class="p-4 md:w-3/5 bg-gray-800 rounded-b-lg md:rounded-r-lg">
...
export default {
    ...
    computed: {
        details() {
            return this.$store.state.keywords.details
        },
        shows() {
            return this.$store.state.keywords.shows;
        },
    },
    methods: {
        getKeywordDetails() {
            this.$store.dispatch('keywords/getKeywordDetails', { id: this.$route.params.id })
        },
        getKeywordMovies() {
            this.$store.dispatch('keywords/getKeywordMovies', { 
        ...
        getKeywordShows() {
            this.$store.dispatch('keywords/getKeywordShows', { 
                id: this.$route.params.id,
                page: this.page,
                sort: this.sort,
                voteCount: this.voteCount

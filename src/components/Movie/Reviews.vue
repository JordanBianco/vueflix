<template>
    <section v-if="reviews">
        ...
        <p class="text-gray-400 text-sm">Questo film ha {{ reviews.total_results }} recensioni</p>
        <div
...
export default {
    ...
    computed: {
        reviews() {
            return this.$store.state.movies.reviews;
        },
    },
    methods: {
        getMovieReviews() {
            this.$store.dispatch('movies/getMovieReviews', {
                id: this.id,
                page: this.page
            });
        },
